          ...
          <div className="max-w-sm mx-auto space-y-10">
            ...
            {step === 3 && (
              <section className="space-y-6 animate-fade-up">
                ...
                {/* Social Media Links */}
                <div className="p-5 bg-surface-container-low rounded-md space-y-3">
                  <p className="text-xs font-extrabold text-on-surface-variant uppercase tracking-wider">Follow us</p>
                  <div className="flex justify-center gap-5 pt-1">
                    {['Instagram', 'TikTok', 'X', 'Facebook'].map((p) => (
                      <a key={p} href={socialUrls[p]} target="_blank" rel="noopener noreferrer" className="text-primary hover:text-primary-dim transition-colors" title={p}>
